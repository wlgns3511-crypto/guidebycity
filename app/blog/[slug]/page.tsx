    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://guidebycity.com/blog/${slug}/`,
            },
          }),
        }}
      />
      ...
      <header className="mb-8">
        ...
        <div className="text-xs text-slate-400 flex items-center gap-3">
          ...
          <span>· GuideByCity Editorial Team</span>
        </div>
      </header>
      ...
      <div className="mt-12 p-6 bg-teal-50 border border-teal-200 rounded-xl">
        ...
        <p className="text-slate-600 text-sm mb-4">
          Use our free tools to look up cost of living, demographics, and quality of life data for 380+ US cities.
        </p>
