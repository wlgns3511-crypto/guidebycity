...
export const metadata: Metadata = {
  ...
  description: "Terms of service for GuideByCity.",
};
...
export default function TermsPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        Welcome to GuideByCity. By accessing or using our website at guidebycity.com, you agree to be bound by these
      ...
      <p>
        GuideByCity provides city guides, cost of living data, and demographic information for informational and
        educational purposes only. You may use the website for personal, non-commercial purposes. You agree not to
        misuse the website or access it using any method other than the interface and instructions we provide.
      </p>
      ...
      <p>
        ...
        sourced from publicly available government datasets. Users should independently verify any information before
        making decisions based on it.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">Intellectual Property</h2>
      <p>
        The content, design, and layout of this website are the property of GuideByCity and are protected by
      ...
      <p>
        To the fullest extent permitted by law, GuideByCity shall not be liable for any indirect, incidental, special,
