...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for GuideByCity.",
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p className="text-sm text-slate-500 mb-8">
        Last updated: <time dateTime={LEGAL_VINTAGES.privacy}>{LEGAL_VINTAGES.privacy}</time>
      </p>

      <p>
        GuideByCity (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates the website guidebycity.com. This
      ...
      <p>
        ...
        <a href="https://www.aboutads.info/choices/" className="text-teal-600 hover:underline" target="_blank" rel="noopener noreferrer">www.aboutads.info</a>.
      </p>
